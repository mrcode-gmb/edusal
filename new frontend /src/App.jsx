...
import DashboardLayout from './institution/DashboardLayout'
import GovernancePulse from './institution/GovernancePulse'
import HierarchyExplorer from './institution/HierarchyExplorer'
import KnowledgeBase from './institution/KnowledgeBase'
import StaffEvaluators from './institution/StaffEvaluators'
import {
  createTheme,
  ThemeProvider,
  CssBaseline,
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Routes>
        ...
        />
        <Route path="/portal/institution" element={<DashboardLayout />}>
          <Route index element={<Navigate to="governance-pulse" replace />} />
          <Route
            path="governance-pulse"
            element={<GovernancePulse />}
          />
          <Route
            path="hierarchy-explorer"
            element={<HierarchyExplorer />}
          />
          <Route
            path="knowledge-base"
          ...
          />
          <Route
            path="staff-evaluators"
            element={<StaffEvaluators />}
          />
        </Route>
