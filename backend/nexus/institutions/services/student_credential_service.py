...
from nexus.institutions.models import StudentProfile
...
class StudentCredentialService:
    ...
    def generate_and_dispatch_credentials(
        ...
        with transaction.atomic():
            ...
            from_email = getattr(settings, "DEFAULT_FROM_EMAIL", f"no-reply@{student.institution.slug}.nexus.ng")

            text_content = f"""
Welcome to Nexus Edutech Consult Ltd Institutional Portal, {student_name}!
...
<body>
  <div class="email-container">
    <div class="email-header">
      <h1>Nexus Edutech Consult Ltd Student Portal</h1>
      <p>{inst_name}</p>
    </div>
    ...
    <div class="email-footer">
      Nexus Edutech Consult Ltd Tertiary Career Governance Platform · {inst_name}
    </div>
  </div>
</body>
</html>
